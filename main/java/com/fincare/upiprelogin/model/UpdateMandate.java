...
public class UpdateMandate {
	...
	public String getInitationmode() {
		return initationmode;
	}
	public void setInitationmode(String initationmode) {
		this.initationmode = initationmode;
	}
